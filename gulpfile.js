...
var dist_paths = {
  assets: `${dir_dist}/assets/themes/${name_theme}`,
  components: `${dir_dist}/components`,
  covers: `${dir_dist}/covers`,
  layouts: `${dir_dist}/layouts`,
  views: `${dir_dist}/views`,
...
gulp.task('assets', function () {
  return gulp.src([
    ...
    .pipe(gulp.dest(dist_paths.assets))
});

gulp.task('components', function () {
  return gulp.src(src_paths.components)
    .pipe(gulp.dest(dist_paths.components))
});

gulp.task('covers', function () {
  return gulp.src(src_paths.covers)
    .pipe(gulp.dest(dist_paths.covers))
});

gulp.task('layouts', function () {
  return gulp.src(src_paths.css)
    .pipe(gulp.dest(dist_paths.layouts))
});
...
gulp.task('views', function () {
  return gulp.src(src_paths.haml)
    ...
    .pipe(gulp.dest(dist_paths.views))
...
gulp.task('watch', ['haml', 'css', 'js', 'sass', 'fonts', 'images', 'scripts', 'assets'], function () {
